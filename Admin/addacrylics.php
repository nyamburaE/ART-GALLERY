...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['acrylicpicture']) && $_FILES['acrylicpicture']['error'] !== UPLOAD_ERR_NO_FILE) {
        // Handle file upload
        $target_dir = "pictures/";
        $target_file = $target_dir . basename($_FILES["acrylicpicture"]["name"]);
        ...
        if (move_uploaded_file($_FILES["acrylicpicture"]["tmp_name"], $target_file)) {
            // Insert file path into database
            $sql = "INSERT INTO  tblacrylics (acrylicpicture, name, description, price) VALUES (?, ?, ?, ?)";
            ...
            if ($stmt->execute()) {
                // Success message
                                       ...
                                       header("refresh:2;url=addacrylics.php");
  ...
  <div class="content-body">
          ...
          <section class="formatter" id="formatter">
              ...
              <div class="row">
                  <div class="form-group">
                      <label style="color: black;">Acrylic Paintings</label>
                      <br>
                      <input type="file" class="form-control-file" id="acrylicpicture" name="acrylicpicture" accept="image/*" required style="color: black;">
                  </div>
                  <!-- Other input fields -->
                  <!-- Name -->
                  <br>
    ...
    <script>
       ...
       function validateForm() {
           var acrylicpicture = document.getElementById("acrylicpicture").value;
           var name = document.getElementById("name").value;
           var description = document.getElementById("description").value;
           var price = document.getElementById("price").value;

           // Check if any field is empty
           if (acrylicpicture === "" || name === "" || description === "" || price === "") {
