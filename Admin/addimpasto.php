...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['	impastopicture']) && $_FILES['	impastopicture']['error'] !== UPLOAD_ERR_NO_FILE) {
        // Handle file upload
        $target_dir = "pictures/";
        $target_file = $target_dir . basename($_FILES["	impastopicture"]["name"]);
        ...
        if (move_uploaded_file($_FILES["	impastopicture"]["tmp_name"], $target_file)) {
            // Insert file path into database
            $sql = "INSERT INTO  tblimpasto (	impastopicture, name, description, price) VALUES (?, ?, ?, ?)";
            ...
            if ($stmt->execute()) {
                // Success message
                                       ...
                                       header("refresh:2;url=addimpasto.php");
  ...
  <div class="content-body">
          ...
          <section class="formatter" id="formatter">
              ...
              <div class="row">
                  <div class="form-group">
                      <label style="color: black;">Impasto Paintings</label>
                      <br>
                      <input type="file" class="form-control-file" id="	impastopicture" name="	impastopicture" accept="image/*" required style="color: black;">
                  </div>
                  <!-- Other input fields -->
                  <!-- Name -->
                  <br>
    ...
    <script>
       ...
       function validateForm() {
           var 	impastopicture= document.getElementById("	impastopicture").value;
           var name = document.getElementById("name").value;
           var description = document.getElementById("description").value;
           var price = document.getElementById("price").value;

           // Check if any field is empty
           if (	impastopicture === "" || name === "" || description === "" || price === "") {
               alert("Please fill in all fields.");
               return false;
           }

           // Check if 	impastopicture is not empty
           if (	impastopicture === "") {
