...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['woodcarvingpicture']) && $_FILES['woodcarvingpicture']['error'] !== UPLOAD_ERR_NO_FILE) {
        // Handle file upload
        $target_dir = "pictures/";
        $target_file = $target_dir . basename($_FILES["woodcarvingpicture"]["name"]);
        ...
        if (move_uploaded_file($_FILES["woodcarvingpicture"]["tmp_name"], $target_file)) {
            // Insert file path into database
            $sql = "INSERT INTO tblwoodcarving (woodcarvingpicture, name, description, price) VALUES (?, ?, ?, ?)";
            ...
            if ($stmt->execute()) {
                // Success message
                                       ...
                                       header("refresh:2;url=addwoodcarving.php");
  ...
  <div class="content-body">
          ...
          <section class="formatter" id="formatter">
              ...
              <div class="row">
                  <div class="form-group">
                      <label style="color: black;">Wood carving picture</label>
                      <br>
                      <input type="file" class="form-control-file" id="woodcarvingpicture" name="woodcarvingpicture" accept="image/*" required style="color: black;">
                  </div>
                  <!-- Other input fields -->
                  <!-- Name -->
                  <br>
    ...
    <script>
       ...
       function validateForm() {
           var woodcarvingpicture = document.getElementById("woodcarvingpicture").value;
           var name = document.getElementById("name").value;
           var description = document.getElementById("description").value;
           var price = document.getElementById("price").value;

           // Check if any field is empty
           if (woodcarvingpicture === "" || name === "" || description === "" || price === "") {
               alert("Please fill in all fields.");
               return false;
           }

           // Check if woodcarvingpicture is not empty
           if (woodcarvingpicture === "") {
               alert("Please select an image for wood carving picture.");
               return false;
           }
