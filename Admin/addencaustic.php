...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['encausticpicture']) && $_FILES['encausticpicture']['error'] !== UPLOAD_ERR_NO_FILE) {
        // Handle file upload
        $target_dir = "pictures/";
        $target_file = $target_dir . basename($_FILES["encausticpicture"]["name"]);
        ...
        if (move_uploaded_file($_FILES["encausticpicture"]["tmp_name"], $target_file)) {
            // Insert file path into database
            $sql = "INSERT INTO  tblencaustic (encausticpicture, name, description, price) VALUES (?, ?, ?, ?)";
            ...
            if ($stmt->execute()) {
                // Success message
                                       ...
                                       header("refresh:2;url=addencaustic.php");
  ...
  <div class="content-body">
          ...
          <section class="formatter" id="formatter">
              ...
              <div class="row">
                  <div class="form-group">
                      <label style="color: black;">Encaustic Paintings</label>
                      <br>
                      <input type="file" class="form-control-file" id="encausticpicture" name="encausticpicture" accept="image/*" required style="color: black;">
                  </div>
                  <!-- Other input fields -->
                  <!-- Name -->
                  <br>
    ...
    <script>
       ...
       function validateForm() {
           var encausticpicture = document.getElementById("encausticpicture").value;
           ...
           // Check if encausticpicture is not empty
           if (encausticpicture === "") {
